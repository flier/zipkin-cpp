...
if (NOT ZLIB_FOUND OR USE_BUNDLED_ZLIB)
    if (NOT DEFINED ZLIB_VERSION_STRING OR USE_BUNDLED_ZLIB)
...
if (NOT CURL_FOUND OR USE_BUNDLED_CURL)
    if (NOT DEFINED CURL_VERSION_STRING OR USE_BUNDLED_CURL)
...
if (NOT RAPIDJSON_FOUND OR USE_BUNDLED_RAPIDJSON)
    if (NOT DEFINED RAPIDJSON_VERSION OR USE_BUNDLED_RAPIDJSON)
...
if (NOT FOLLY_FOUND OR USE_BUNDLED_FOLLY)
    if (NOT DEFINED FOLLY_VERSION OR USE_BUNDLED_FOLLY)
...
if (NOT LIBRDKAFKA_FOUND OR USE_BUNDLED_LIBRDKAFKA)
    if (NOT DEFINED LibRDKafka_VERSION OR USE_BUNDLED_LIBRDKAFKA)
...
if (NOT DOUBLE_CONVERSION_FOUND OR USE_BUNDLED_DOUBLE_CONVERSION)
    if (NOT DEFINED DOUBLE_CONVERSION_VERSION OR USE_BUNDLED_DOUBLE_CONVERSION)
...
if (NOT THRIFT_FOUND OR USE_BUNDLED_THRIFT)
    if (NOT DEFINED THRIFT_VERSION_STRING OR USE_BUNDLED_THRIFT)
...
if (NOT GFLAGS_FOUND OR USE_BUNDLED_GFLAGS)
    if (NOT DEFINED GFLAGS_VERSION OR USE_BUNDLED_GFLAGS)
...
if (NOT GLOG_FOUND OR USE_BUNDLED_GLOG)
    if (NOT DEFINED GLOG_VERSION OR USE_BUNDLED_GLOG)
...
if (NOT GTEST_FOUND OR USE_BUNDLED_GTEST)
    if (NOT DEFINED GTEST_VERSION OR USE_BUNDLED_GTEST)
...
if (NOT GBENCH_FOUND OR USE_BUNDLED_GBENCH)
    if (NOT DEFINED GBENCH_VERSION OR USE_BUNDLED_GBENCH)
