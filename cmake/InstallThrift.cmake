ExternalProject_Add(thrift
    ...
    CONFIGURE_COMMAND   CPPFLAGS=-I<BINARY_DIR>/lib/cpp/src <SOURCE_DIR>/configure --prefix=<INSTALL_DIR> --with-openssl=${OPENSSL_ROOT_DIR} --with-boost=${BOOST_ROOT} --without-c_glib --without-csharp --without-python --without-java --without-nodejs --without-lua --without-ruby --without-php --without-erlang --without-go --without-nodejs --without-qt4 --without-qt5
    BUILD_COMMAND       make
